    ...
    <div class="wrapper">
      <div class="container">
        ...
        <div class="card">
          ...
          <p class="intro">
            Jūsų užsakymas sėkmingai gautas. Esame džiaugsmingi, kad pasirinkote
            <strong>Vasaros Kampelis</strong> — mes jau ruošiamės jį komplektuoti ir išsiųsti kuo greičiau.
          </p>
          ...
          <div class="steps">
            ...
            <div class="step">
              ...
              <div class="step-text">
                <strong>Užsakymas gautas</strong>
                <span>Jūsų užsakymas sėkmingai apdorotas.</span>
              </div>
            </div>
            ...
            <div class="step">
              ...
              <div class="step-text">
                <strong>Ruošiamas siuntai</strong>
                <span>Mūsų komanda komplektuoja jūsų prekes.</span>
              </div>
            </div>
            ...
            <div class="step">
              ...
              <div class="step-text">
                <strong>Išsiųsta</strong>
                <span>Gausite el. laišką su sekimo numeriu.</span>
              </div>
            </div>
          </div>

          <div class="cta-wrap">
            <a href="https://www.vasaroskampelis.com/" class="cta-btn"> Grįžti į parduotuvę → </a>
          </div>
          ...
          <div class="help">
            ...
            <p>Rašykite mums: <a href="mailto:vasaroskampelis@gmail.com">vasaroskampelis@gmail.com</a></p>
          </div>
        </div>
